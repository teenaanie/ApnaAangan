    ...
    <>
      ...
      <Shell>
        ...
        <section className="pt-9 pb-7 max-w-[62ch]">
          <p className="section-header mb-3">What it costs</p>
        ...
        <section className="pt-7 border-t border-sandstone-soft">
          <h2 className="text-[20px] mb-1.5">The three rates</h2>
          <p className="text-charcoal-soft text-sm mb-5 max-w-[62ch]">
          ...
          <div className="grid gap-3.5 sm:grid-cols-3">
            {([1, 2, 3] as Tier[]).map((t) => (
              <Card key={t} className="p-4">
                ...
                <p className="display text-[30px] text-mustard leading-none mt-3">
                  {rupees(TIERS[t].fee)}
                </p>
                <p className="text-[12px] text-charcoal-faint mt-1">
                  per enquiry you accept
                </p>
                <p className="text-[13px] text-charcoal-soft mt-2.5 leading-snug">
                  {TIERS[t].forWhat}
                </p>
                <p className="text-[12px] text-charcoal-faint mt-2.5 leading-snug border-t border-sandstone-soft pt-2.5">
        ...
        <section className="pt-9">
          <h2 className="text-[20px] mb-1.5">What goes in each category</h2>
          <p className="text-charcoal-soft text-sm mb-5 max-w-[62ch]">
              ...
              <Card key={c.slug} className="p-4 flex flex-col">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      <h3 className="text-[15.5px] font-semibold m-0 text-charcoal">
                        {c.label}
                      </h3>
                    ...
                    <p className="text-[12.5px] text-charcoal-soft mt-1 leading-snug">
                      {c.blurb}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-1.5 flex-wrap mt-3">
                  {c.services.map((s) => (
                    <span
                      key={s}
                      className="text-[11.5px] px-2 py-1 rounded-full bg-cream-deep border border-sandstone-soft text-charcoal-soft"
                    >
                      {s}
                    </span>
                  ))}
                ...
                {c.flag && (
                  <p className="text-[12px] leading-relaxed mt-3 pt-3 border-t border-sandstone-soft text-mustard">
                    {c.flag}
                  </p>
                )}
              </Card>
        ...
        {/* -------------------------------------------------------- examples */}
        <section className="pt-9">
          <h2 className="text-[20px] mb-1.5">What that adds up to</h2>
          <p className="text-charcoal-soft text-sm mb-5 max-w-[62ch]">
          ...
          <div className="grid gap-3.5 sm:grid-cols-3">
            {WORKED_EXAMPLES.map((e) => (
              <Card key={e.title} className="p-4 flex flex-col">
                <h3 className="text-[15.5px] font-semibold m-0">{e.title}</h3>
                <p className="text-[12px] text-charcoal-faint mt-0.5 mb-3">{e.who}</p>
                <dl className="text-[13px]">
                  {e.rows.map(([k, v]) => (
                    ...
                    >
                      ...
                      <dd className="font-semibold text-charcoal m-0">{v}</dd>
                    </div>
                  ))}
                </dl>
                <p className="text-[12.5px] text-sage-deep leading-snug mt-3 pt-3 border-t border-sandstone-soft">
                  {e.punch}
                </p>
              </Card>
            ))}
        ...
        {/* ------------------------------------------------------------ FAQs */}
        <section className="pt-9">
          <h2 className="text-[20px] mb-5">Questions people ask</h2>
          <div className="grid gap-3 sm:grid-cols-2">
            {FAQS.map((f) => (
              <Card key={f.q} className="p-4">
                <h3 className="text-[14.5px] font-semibold m-0 mb-1.5">{f.q}</h3>
        ...
        <section className="py-10">
          <Card className="p-6 sm:p-8 bg-terracotta-tint border-terracotta/25">
            <h2 className="text-[22px] mb-1.5">Nothing is being collected yet.</h2>
          ...
          <p className="text-[12px] text-charcoal-faint mt-4 max-w-[62ch] leading-relaxed">
            ...
            <Link href="/" className="underline hover:text-terracotta">
...
function Headline({ value, label }: { value: React.ReactNode; label: string }) {
  return (
    <div className="bg-surface border border-sandstone-soft rounded-2xl px-4 py-3.5">
      <p className="display text-[26px] text-mustard leading-none">{value}</p>
      <p className="text-[12px] text-charcoal-soft mt-1.5">{label}</p>
    </div>
  );
}
